...
public partial class OraclePage
{
    private Oracle oracle = new();
    private OracleRoll selectedPair = new();
    private Table tableRowToAdd = new() { Floor = 101, Ceiling = 101 };

    private MudTextField<string> addTableResultText = new();
    ...
    private async Task EnterOnAddTableRow(KeyboardEventArgs args)
    {
    ...
    private void RemoveFromTable(Table value)
    {
